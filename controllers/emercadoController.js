...
const getCategories = async (req, res) => {
  try {
    ...
    console.error("Se rompio en getCategories (controller): " + error);
...
const getCategoryById = async (req, res) => {
  ...
  try {
    ...
    console.error("Se rompio en getCategoryById (controller): " + error);
...
const getProductById = async (req, res) => {
  ...
  try {
    ...
    console.error("Se rompio en getProductById (controller): " + error);
...
const getCommentsById = async (req, res) => {
  ...
  try {
    ...
    console.error("Se rompio en getCommentsById (controller): " + error);
...
const getCartById = async (req, res) => {
  ...
  try {
    ...
    console.error("Se rompio en getCartById (controller): " + error);
